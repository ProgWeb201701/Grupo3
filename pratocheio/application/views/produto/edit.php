<div class="row-fluid">
    <?php echo form_open_multipart('produto/editar/' . $produto['id_produto'], array("class" => "form-horizontal")); ?>
    ...
    <div class="col-sm-9 ">
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input type="number" step=".01" name="preco" value="<?php echo ($this->input->post('preco') ? $this->input->post('preco') : number_format($produto['preco'],2)); ?>" class="form-control" id="preco" />
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <textarea name="descri" rows="5" cols="60" class="form-control" id="descri"><?php echo ($this->input->post('descri') ? $this->input->post('descri') : $produto['descri']); ?></textarea>
