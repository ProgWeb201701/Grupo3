<?php echo form_open('itempedido/edit/'.$itempedido['id_item'],array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<select name="id_produto" class="form-control">
				...
				{
					$selected = ($produto['id_produto'] == $itempedido['id_produto']) ? ' selected="selected"' : "";
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="valor" value="<?php echo ($this->input->post('valor') ? $this->input->post('valor') : $itempedido['valor']); ?>" class="form-control" id="valor" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="quantidade" value="<?php echo ($this->input->post('quantidade') ? $this->input->post('quantidade') : $itempedido['quantidade']); ?>" class="form-control" id="quantidade" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="observacoes" value="<?php echo ($this->input->post('observacoes') ? $this->input->post('observacoes') : $itempedido['observacoes']); ?>" class="form-control" id="observacoes" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="id_pedido" value="<?php echo ($this->input->post('id_pedido') ? $this->input->post('id_pedido') : $itempedido['id_pedido']); ?>" class="form-control" id="id_pedido" />
