<?php echo form_open('pedido/add',array("class"=>"form-horizontal")); ?>
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="valor_total" value="<?php echo $this->input->post('valor_total'); ?>" class="form-control" id="valor_total" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="dataHora" value="<?php echo $this->input->post('dataHora'); ?>" class="form-control" id="dataHora" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="previsaoEntrega" value="<?php echo $this->input->post('previsaoEntrega'); ?>" class="form-control" id="previsaoEntrega" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="statusAndamento" value="<?php echo $this->input->post('statusAndamento'); ?>" class="form-control" id="statusAndamento" />
	...
	<div class="form-group">
		...
		<div class="col-md-8">
			<input type="text" name="tipoEntrega" value="<?php echo $this->input->post('tipoEntrega'); ?>" class="form-control" id="tipoEntrega" />
